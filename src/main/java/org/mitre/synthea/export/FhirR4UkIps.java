...
public class FhirR4UkIps {
   ...
   * @return FHIR Bundle containing the Person's health record in IPS format
   */
  public static Bundle convertToFHIRIps(Person person, long stopTime) {

    String miscIdValue = UUID.randomUUID().toString();
    Bundle bundle = new Bundle();
    bundle.setType(BundleType.DOCUMENT);

    bundle.setId(miscIdValue);
    Meta meta = new Meta();
    meta.addProfile("http://hl7.org/fhir/uv/ips/StructureDefinition/Bundle-uv-ips");
    bundle.setMeta(meta);

    bundle.setLanguage("en");
    bundle.setIdentifier(new Identifier()
        .setSystem("urn:oid:2.16.724.4.8.10.200.10")
        .setValue(miscIdValue));

    bundle.setTimestamp(new Date());

    BundleEntryComponent compositionEntry = ipsComposition(person, bundle);
    ...
    for (Encounter encounter : person.record.encounters) {
      ...
      if (shouldExport(AllergyIntolerance.class)) {
        for (Allergy allergy : encounter.allergies) {
...
//        }
  ...
  public static String convertToFHIRJson(Person person, long stopTime) {
    Bundle bundle = convertToFHIRIps(person, stopTime);
  ...
  private static BundleEntryComponent ipsComposition(Person person, Bundle bundle) {
    Composition ips = new Composition();
    String miscIdValue = UUID.randomUUID().toString();
    Meta meta = new Meta();
    meta.addProfile("http://hl7.org/fhir/uv/ips/StructureDefinition/Bundle-uv-ips");
    ips.setMeta(meta);
    ...
    ips.setLanguage("en");
    ips.setIdentifier(new Identifier()
        .setSystem("urn:oid:2.16.724.4.8.10.200.10")
        .setValue(miscIdValue));

    String generatedBySynthea = "Generated by Synthea." + " Version identifier: " + Utilities.SYNTHEA_VERSION;

    ips.setText(new Narrative().setStatus(NarrativeStatus.GENERATED)
        .setDiv(new XhtmlNode(NodeType.Element).setValue(generatedBySynthea)));

    ips.setStatus(Composition.CompositionStatus.FINAL);

    Coding ipsTypeCode = new Coding();
    ipsTypeCode.setSystem(LOINC_URI);
    ipsTypeCode.setCode("60591-5");
    ipsTypeCode.setDisplay("Patient summary Document");
    ips.setType(new CodeableConcept(ipsTypeCode));

    ips.setTitle("International Patient Summary");
    ips.setConfidentiality(Composition.DocumentConfidentiality.N);

    return newEntry(bundle, ips, UUID.randomUUID().toString());
  }
...
//                .setValue((String) person.attributes.get(Person.ID));
    ...
    CodeableConcept birthSexCode = new CodeableConcept();
    Extension birthSexExtension = new Extension("https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-BirthSex");
    if (person.attributes.get(Person.GENDER).equals("M")) {
      patientResource.setGender(AdministrativeGender.MALE);
      birthSexCode = new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-AdministrativeGender", "M", "Male"));
      birthSexCode.setText("Male");
      birthSexExtension.setValue(birthSexCode);
    } else if (person.attributes.get(Person.GENDER).equals("F")) {
      patientResource.setGender(AdministrativeGender.FEMALE);
      birthSexCode = new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-AdministrativeGender", "F", "Female"));
      birthSexCode.setText("Female");
      birthSexExtension.setValue(birthSexCode);
    } else if (person.attributes.get(Person.GENDER).equals("UNK")) {
      patientResource.setGender(AdministrativeGender.UNKNOWN);
      birthSexCode = new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v3-NullFlavor", "UNK", "unknown"));
      birthSexCode.setText("unknown");
      birthSexExtension.setValue(birthSexCode);
    }
//        if (USE_US_CORE_IG) {
  ...
  private static BundleEntryComponent allergy(
    ...
    if (allergy.reactions != null) {
      ...
      sortedReactions.forEach(manifestation -> {
        ...
        ReactionSeverity severity = allergy.reactions.get(manifestation);
        if (severity != null) {
          switch (severity) {
            case MILD:
...
//            }
   ...
   * @return
   */
  static SampledData mapValueToSampledData(
      Components.SampledData value, String unit) {

    SampledData recordData = new SampledData();
  ...
  private static BundleEntryComponent supplyDelivery(
      BundleEntryComponent personEntry, Bundle bundle, Supply supply,
      Encounter encounter) {
  ...
  private static BundleEntryComponent media(
    ...
    if (content.data != null) {
      contentResource.setDataElement(new Base64BinaryType(content.data));
    } else {
    ...
    if (content.hash != null) {
      contentResource.setHashElement(new Base64BinaryType(content.hash));
    }
  ...
  private static String ukEthnicityDisplay(String code) {
    ...
    switch (code) {
      ...
      case "B":
        return "White - Irish";
      case "C":
        return "White - Any other White background";
      case "D":
      ...
      case "G":
        return "Mixed - Any other mixed background";
      case "H":
      ...
      case "L":
        return "Asian or Asian British - Any other Asian background";
      case "M":
        return "Black or Black British - Caribbean";
      case "N":
        return "Black or Black British - African";
      case "P":
        return "Black or Black British - Any other Black background";
      case "R":
        return "Other Ethnic Groups - Chinese";
      case "S":
        return "Other Ethnic Groups - Any other ethnic group";
      case "Z":
        return "Not stated";
      case "99":
        return "Not known";
